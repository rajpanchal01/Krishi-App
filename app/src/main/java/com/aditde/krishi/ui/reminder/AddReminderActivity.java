...
import com.aditde.krishi.ui.reminder.reminder.AlarmScheduler;
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(AddReminderActivity.this); //specify entire path if bugzzzz ie com.aditde...
                    return true;
                }
                ...
                DialogInterface.OnClickListener discardButtonClickListener =
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                NavUtils.navigateUpFromSameTask(AddReminderActivity.this); //specify entire path if bugz
                            }
                        };
